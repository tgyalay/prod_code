'''
This module contains constants that are used by the library and testing
scripts. If for example, the output directory is changed, the tests
will still work because both scripts use the same values.
'''
